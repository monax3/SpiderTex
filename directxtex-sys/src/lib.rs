...
// FIXME
pub type DDS_FLAGS = u32;
pub type TGA_FLAGS = u32;
pub type WIC_FLAGS = u32;
...
extern "C" {
    ...
    pub fn V2_Compress(image: DXPtr, to_format: DXGI_FORMAT, dst: *mut DXPtr) -> HRESULT;
    pub fn V2_Decompress(image: DXPtr, dst: *mut DXPtr) -> HRESULT;
    pub fn V2_Convert(
        image: DXPtr,
    ...
    pub fn V2_PremultiplyAlpha(image: DXPtr, reverse: bool, dst: *mut DXPtr) -> HRESULT;
    ...
    pub fn Clone(image: DXPtr, dst: *mut DXPtr) -> HRESULT;
